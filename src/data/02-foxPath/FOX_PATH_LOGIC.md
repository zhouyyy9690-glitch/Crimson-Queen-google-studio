...
| `samiaTalkedSecret` | 是否听取了萨米娅的警告 | `Day2/08.ts` | 决定是否进入 `F134` 警告情节，影响对红堡秘密的感知。 |
...
4.  **萨米娅的教导分支 (`Day2/08.ts`)**
    *   **听从 (`F134-SamiaFollow`)**：萨米娅好感+2。凯瑟琳被告知“小心身边人”，深化了萨米娅作为潜在盟友或危险因素的复杂性。
    *   **敌视 (`F135-SamiaHostile`)**：萨米娅好感+0。维持生硬的师徒关系，错失情报。

5.  **达里安·雷斯多的初遇 (`Day2/09.ts`)**
    *   **固定触发**：剧情必经之路。
    *   **好感提升**：通过“叶笛”互动，达里安好感由初始10（贵族身份）提升至30。这是游戏中第一个明确的同龄人情感慰藉点。
